...
/**
     ...
     * 
     * @param virtAddr	the virtual address whose physical address we want to know
     * @return 			the integer value of the physical address in RAM
     */
    private int translate(int virtAddr)
    {
        // TODO : This method    	
    	int offset = virtAddr & getOffsetMask();
    	int pageNum = (virtAddr & getPageMask()) >> getOffsetSize();
    	
    	int physAddr = (pageNum * getPageSize()) + offset;
